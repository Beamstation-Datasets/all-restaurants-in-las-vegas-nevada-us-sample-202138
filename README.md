# All Restaurants in Las Vegas, Nevada, US

> Free BeamStation sample export with 364 rows and masked direct-contact fields.
...
| Full dataset size | 3,642 records |
| Free sample size | 364 records (9.99%) |
| Last export | 2026-04-28T23:56:15.537220+00:00 |
| Download | [Latest release asset](https://github.com/Beamstation-Datasets/all-restaurants-in-las-vegas-nevada-us-sample-202138/releases/download/sample-latest/beamstation_202138_restaurants-us-nv_SAMPLE_DIST.csv) |
...
Search for dataset ID `202138` on BeamStation if you want the exact commercial listing.
